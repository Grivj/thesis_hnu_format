...
the threshold values for the two scores. $f_1$ and $f_2$ are the two functions
...
continues on and does the same for each remaining $\kappa$ and returns "$False$"
if none of the scores went above their respective thresholds, indicating that
the input image is a normal image.
